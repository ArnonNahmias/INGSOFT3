...
const teamMembers = [
  ...
  },
  {
    ...
    description:
      "Joaquin es el fundador de nuestra plataforma de cursos con más de 20 años de experiencia en la industria educativa.",
  },
  {
    name: "Arnon Nahmias",
    role: "CEO & Founder",
    ...
    description:
      "Arnon  es el fundador de nuestra plataforma de cursos con más de 20 años de experiencia en la industria educativa.",
  },
  {
    name: "Francisco Ruibal",
    role: "CEO & Founder",
    image: "https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSr5Rk5rAwV2Mp89qbM31vsYh_Tsnc0mX6TWtRm2kBOhod27yys",
    description:
      "Francisco  es el fundador de nuestra plataforma de cursos con más de 20 años de experiencia en la industria educativa.",
  },
  {
    name: "Justina Antonucci",
    role: "CEO & Founder",
    image: "https://cdn.forbescentroamerica.com/2020/06/Kylie-Jenner-Forbes-1280x720-1.jpg",
    description:
      "Justina  es la fundadora de nuestra plataforma de cursos con más de 20 años de experiencia en la industria educativa.",
  },
];
